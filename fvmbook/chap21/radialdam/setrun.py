...
#------------------------------
    ...
    probdata.add_param('x0',     0.0,  'x0')
    probdata.add_param('y0',     0.0,  'y0')
    probdata.add_param('r0',     0.5,  'r0')
    probdata.add_param('hin',     2.0,  'depth for r < r0')
    probdata.add_param('hout',     1.0,  'depth for r > r0')
    ...
    clawdata.lower[0] = -2.500000e+00          # xlower
    clawdata.upper[0] = 2.500000e+00          # xupper
    clawdata.lower[1] = -2.500000e+00          # ylower
    clawdata.upper[1] = 2.500000e+00          # yupper
