...
#------------------------------
    ...
    probdata.add_param('eps',     0.4,  'amplitude of wave')
    probdata.add_param('Bocean',  -4000.,  'depth of ocean')
    probdata.add_param('Bshelf',     -200.,  'depth of shelf')
    probdata.add_param('width',     1.,  'width of slope')
    probdata.add_param('start',     -30.e3,  'start of slope')
    ...
    clawdata.lower[0] = -4.000000e+05          # xlower
    clawdata.upper[0] = 0.000000e+00          # xupper
    ...
    clawdata.dt_initial = 1.000000e+00
