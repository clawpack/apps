...
#------------------------------
    ...
    gaugeno = 0
    for d in np.linspace(1550e3,1650e3,11):
        gaugeno = gaugeno+1
    ...
    if theta_island == 190:
        ...
        regions.append([1, 3, 0.e0, 7000., -5., 5., 35., 55.])
    if theta_island == 220:
        regions.append([1, 2, 0.e0, 7000., -5., 20., 35., 55.])
        regions.append([1, 3, 0.e0, 7000., -5., 20., 35., 55.])
        regions.append([1, 2, 7000., 9000., 10., 20., 45., 52.])
    if theta_island == 260:
        regions.append([1, 2, 0.e0, 1.e10, -5., 20., 35., 45.])
        regions.append([1, 3, 0.e0, 7000., -5., 20., 35., 45.])
