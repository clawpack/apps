...
#------------------------------
    ...
    rundata.gaugedata.gauges.append([2, 0.5, 0.5, 0., 10.])
    ...
    # Note: clawdata.checkpt_style < 0 ==> use two alternating checkpoint files
    # rather than generating a new file at each checkpoint time, to reduce storage
